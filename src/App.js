...
function App() {
  const classes = styles(); //call css styles

  return (
    <div className="App">
      {/* creating a themeprovider and giving the theme prop */}
      <ThemeProvider theme={theme}>
        ...
        <div className={classes.wrapper}>
          ...
          <Typography variant="h5" className={classes.littleSpace} color="primary">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean sodales conggue teis
          </Typography>
        </div>
        {/* INCLUDING 2 CSS CLASSES IN REACT AS BELOW*/}
